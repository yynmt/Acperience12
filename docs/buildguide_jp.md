...
Kailhソケットとリセットスイッチが付属していない場合は、メインPCBに既に実装されています。
...
DMM.makeよりご購入いただくか、BOOTHにて3Dプリントデータをご購入いただきご自身で3Dプリントしていただくことができます。

- [Acperience12 Aspecio Shell - DMM.make](https://make.dmm.com/item/1290202/)
- [Acperience12 - BOOTH](https://yynmt.booth.pm/items/2941966)
...
SW1からSW12を順に短絡させると`1 2 3 4 5 6 7 8 9 a b c`と入力されます。
...
　販売形式によっては既にKailhソケットとリセットスイッチが実装されています。
その場合はこの手順をスキップしてください。
...
|![](../images/buildguide_02-03-01.png)|![](../images/buildguide_02-03-02.png)|![](../images/buildguide_02-03-03.png)|
|---|---|---|
...
動作しないキースイッチはピンが折れ曲がってしまっている可能性があります。
...
アクセントプレートはアクリル製です。
強くネジを締めすぎるとアクセントプレートが破損する可能性があるためご注意ください。
